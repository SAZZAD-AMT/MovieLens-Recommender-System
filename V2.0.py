...
def recommend_movies():
    ...
    movie_similarity_user = cosine_similarity(user_ratings, ratings_pivot)
    recommended_movies = get_recommendations(movie_title, movie_similarity_user, mean_ratings)
...
user_label = ttk.Label(window, text='Enter a user id:')
user_label.pack(pady=10)

user_entry = ttk.Entry(window, width=10)
user_entry.pack()
